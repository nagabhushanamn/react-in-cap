...
import { loadReviews, addNewReview } from '../actions/review'
...
class Item extends Component {
    ...
    submitNewReview(e) {
        ...
        this.props.addNewReview(itemId, review)
    }
    rendeTabPanel(item) {
        ...
        switch (currentTab) {
            ...
            case 3: return (
                <div>
                    {this.renderReviews()}
                    <ReviewForm onSubmit={e => this.submitNewReview(e)} />
                </div>
            )
            default: return null
        }
...
const mapDisptachToProps = { loadReviews, buy, addNewReview }
